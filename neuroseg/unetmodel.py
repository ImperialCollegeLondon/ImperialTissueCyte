...
def get_unet(do=0, activation=ReLU):
    ...
    conv4 = Dropout(do)(activation()(Conv2D(64, (3, 3), padding='same')(up4)))
    conv4 = Dropout(do)(activation()(Conv2D(64, (3, 3), padding='same')(conv4)))

    up5 = concatenate([Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same')(conv4), conv1], axis=3)
    conv5 = Dropout(do)(activation()(Conv2D(32, (3, 3), padding='same')(up5)))
    conv5 = Dropout(do)(activation()(Conv2D(32, (3, 3), padding='same')(conv5)))
