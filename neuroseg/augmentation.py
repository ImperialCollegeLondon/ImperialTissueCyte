...
def augment(n):
    training_datagen = Augmentor.Pipeline(source_directory='input/training_data/images', output_directory='.', save_format='tif')

    training_datagen.ground_truth('input/training_data/masks')
