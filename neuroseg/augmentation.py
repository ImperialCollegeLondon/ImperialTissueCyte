...
def augment(n):
    for category in ['images', 'masks']:
        training_datagen = Augmentor.Pipeline(source_directory=os.path.join('input/training_data',category), output_directory='.', save_format='tif')

        Augmentor.Pipeline.set_seed(100)
