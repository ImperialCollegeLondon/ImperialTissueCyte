...
Dialog.addNumber("Percent overlap between steps:",5);
Dialog.addNumber("Number of Z layers per section:",1);
Dialog.addChoice("Select number of channels",channels);
Dialog.show();
...
run("Stitch Sequence of Grids of Images", commandstrng1);
run("Collect Garbage");
...
run("Stitch Sequence of Grids of Images", commandstrng2);
run("Collect Garbage");
print("All images stitched.");
...
run("Stitch Sequence of Grids of Images", commandstrng3);
run("Collect Garbage");
print("All images stitched.");
