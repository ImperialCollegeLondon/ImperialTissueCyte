...
if __name__ == '__main__':
    ...
    # E.g. 'LGd, LGv, IGL, RT'
    if mask:
        mask_path = '/mnt/TissueCyte80TB/181012_Gerald_KO/ko-Mosaic/ko181012_segres_10um.tif'
        structure_list = 'LGd'
    ...
    count_path = '/Users/gm515/Desktop/PFC'
    ...
    for name, structure in zip(acr,ids):
        ...
        if proceed:
            ...
            csv_file = count_path+'/counts/'+str(name)+'_v4_count.csv'
