...
if __name__ == '__main__':
    ...
    parser.add_argument('-modelpath', default='models/2019_08_21_Inception/inception_model.json', type=str, dest='modelpath', help='Model path')
    parser.add_argument('-weightspath', default='models/2019_08_21_Inception/inception_weights_e45_va0.9886.h5', type=str, dest='weightspath', help='Weights path')
