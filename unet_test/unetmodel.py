...
def unet(optfn, lossfn, actfn, inputsize=(None, None, 1)):
    ...
    up7 = Conv2D(128, 2, activation = actfn, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv6))
    ...
    up8 = Conv2D(64, 2, activation = actfn, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv7))
    ...
    up9 = Conv2D(32, 2, activation = actfn, padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv8))
